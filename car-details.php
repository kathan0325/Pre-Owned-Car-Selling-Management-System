...
if(isset($_POST['send']))
  {
    ...
    $enquirynumber = mt_rand(100000000, 999999999);
     $carid=$_GET['carid'];
    $query1=mysqli_query($con,"insert into  tblenquiry(CardId,FullName,Email,MobileNumber,Message,EnquiryNumber,Status) values('$carid','$fullname','$email','$mobilenumber','$message','$enquirynumber', 'Unanswer')");
        if ($query1) {
