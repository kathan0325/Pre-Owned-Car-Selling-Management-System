          ...
          <div class="col-lg-4 col-md-6">
            <div class="product-item">
              ...
              <div class="down-content">
                ...
                <h6>Rs <?php echo $row['CarPrice'];?></h6>
          ...
          <div class="col-md-12">
            <div class="owl-clients owl-carousel text-center">
              <div class="service-item">
                ...
                <div class="down-content">
                  <h4>Aditya Patel</h4>
                  <p class="n-m"><em>"This is best website i ever visited for pre-owned car i get the best response and best matches according to my budget.."</em></p>
                </div>
              </div>
